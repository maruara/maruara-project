...
.cb_module .cb_paginate2 a{display:inline-block;background:url(../images/prototype/comment/bg_sprite_ico.gif) no-repeat;font-weight:bold}
...
.cb_module .cb_thumb .cb_admin,.cb_module .cb_thumbs .cb_admin{position:absolute;left:0;bottom:0;width:40px;height:12px;background:url(../images/prototype/comment/bg_shadow_label.png) 0 0 no-repeat;_background:none;_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='../images/prototype/comment/bg_shadow_label.png',sizingMethod='crop')}
...
.cb_module .cb_usr_area button span{padding-right:8px;background:url(../images/prototype/comment/bg_sprite_ico.gif) 100% 6px no-repeat}
.cb_module .cb_usr_area button.cb_help{width:14px;height:14px;*margin-top:2px;padding:0;border:none;background:url(../images/prototype/comment/btn_tip.gif) 0 0 no-repeat;text-align:left;cursor:pointer}
.cb_module .cb_usr_area button.cb_help span{display:none}
.cb_module .cb_usr_area button.cb_over2 span{background:url(../images/prototype/comment/bg_sprite_ico.gif) 100% -464px no-repeat;color:#333;text-decoration:underline}
...
.cb_module .cb_lstcomment .cb_info_area2 a{display:inline-block;padding-right:10px;background:url(../images/prototype/comment/bg_sprite_ico.gif) 100% -220px no-repeat;color:#404040;text-decoration:none;vertical-align:baseline}
...
.cb_module .cb_lstcomment .cb_section2 span{display:inline-block;overflow:hidden;padding:0 6px 0 9px;background:url(../images/prototype/comment/bg_sprite_ico.gif) 0 -388px no-repeat;color:#aaa}
...
.cb_module .cb_lstcomment .cb_section2 .cb_activate_up em,.cb_module .cb_lstcomment .cb_section2 .cb_activate_down em,.cb_module .cb_lstcomment .cb_section2 .cb_activate_cancel em{display:block;*display:inline;margin-top:-2px;_margin-top:0;padding-left:17px;background:url(../images/prototype/comment/bg_sprite_ico.gif) no-repeat;vertical-align:top;*vertical-align:baseline}
...
.cb_module .cb_lstcomment li li{clear:both;position:relative;padding-bottom:0;border:none;background:url(../images/prototype/comment/bg_pattern_x.gif) 0 0 repeat-x}
...
.cb_module .cb_star_grade{display:inline-block;width:80px;height:16px;margin:-1px 0 0 -1px;background:url(../images/prototype/comment/bg_sprite_ico.gif) 0 -300px no-repeat;vertical-align:top}
.cb_module .cb_star_grade span{display:inline-block;width:80px;height:16px;margin:0;background:url(../images/prototype/comment/bg_sprite_ico.gif) 0 -340px no-repeat;vertical-align:top}
...
.cb_module .cb_ly_popup .cb_module .cb_ly_popup .cb_close:hover span{background:url(../images/prototype/comment/bg_sprite_btn.gif) -19px -310px no-repeat}
:root .cb_module .cb_ly_popup .cb_close{top:8px;right:8px;padding:0}
.cb_module .cb_ly_popup .cb_close span{display:block;position:relative;width:19px;height:19px;margin:0;padding:0;border:none;background:url(../images/prototype/comment/bg_sprite_btn.gif) 0 -310px no-repeat;font-size:0}
.cb_module .cb_ly_popup .cb_close em{display:none}
.cb_module .cb_ly_popup .cb_over span{background:url(../images/prototype/comment/bg_sprite_btn.gif) -19px -310px no-repeat}
...
.cb_module,.cb_module .cb_input_txt,.cb_module .cb_nick_name a,.cb_module h5.cb_h_type,.cb_module .cb_wrts_message .cb_input_txt,.cb_module .cb_usr_area button,.cb_module .cb_txt_area textarea,.selectbox-list ul li,.cb_module td{font-family:'나눔고딕',NanumGothic}
				...
				<div class="cb_comment_area">
					<div class="cb_info_area">
						<div class="cb_section">
							<span class="cb_nick_name">정우성</span>
						...
						<div class="cb_section2">
							...
							<span class="cb_nobar"><a href="#">신고</a></span>
						</div>
					</div>
										...
										<fieldset>
											...
											<div class="cb_usr_area">
												<div class="cb_txt_area">
													<div class="cb_section">
														<textarea cols="80" rows="20" name="">1</textarea>
													...
													<div class="cb_dsc_area">
														<p class="cb_dsc">
															<input type="checkbox" name="chk_submit_m2day" id="chk_submit_m2day" class="cb_input_chk">
															<label for="chk_submit_m2day" class="cb_blind">미투데이 글 등록</label>
															<span><a href="#" target="_blank">나의 미투데이</a>에 글을 등록합니다.</span>
														</p>
														<div class="cb_btn_area3">
															...
															<div class="cb_ly_popup" style="display:none; width:278px; left:0; top:0">
																<button type="button" class="cb_close"><span><em>닫기</em></span></button>
																<p class="cb_dsc6">
																	체크박스를 선택하여 <a href="#" target="_blank">미투데이</a>에 글을<br>
																	동시에 등록할 수 있습니다.<br>
																	이를 위해서는 미투데이 주소인증이 필요합니다.<br>
																	<span><a href="#"><strong>미투데이 인증하기</strong></a></span>
																</p>
															</div>
															<div class="cb_cb"></div>
														</div>
														<p class="cb_dsc3"><a href="#" target="_blank">인증해제</a></p>
														<div class="cb_dsc2">
															<p><a href="#" target="_blank">사용자평 운영정책</a></p>
														</div>
													</div>
												</div>
											</div>
				...
				<ul>
					<li class="cb_thumb_off">
						...
						<div class="cb_comment_area">
							<div class="cb_info_area">
								<div class="cb_section">
									<span class="cb_nick_name">한예슬</span>
									<span class="cb_usr_id">(wonbeen)</span>
									<span class="cb_date">2009-06-17 10:25</span>
								</div>
								<div class="cb_section2">
							...
							<div class="cb_dsc_comment">
								<p class="cb_dsc">
									바이러스는 RNA를 가지고 세포의 DNA에 끼어들어가서 자기복제를 합니다.
								</p>
							</div>
						</div>
						<ul>
											...
											<form action="#" method="post">
												<fieldset>
													...
													<div class="cb_usr_area">
														<div class="cb_txt_area">
															<div class="cb_section">
																<textarea cols="80" rows="20" name="">2</textarea>
																<div class="cb_btn_area">
																	<input type="image" src="http://static.naver.com/common/comment/btn_registry.gif" alt="등록">
																</div>
															</div>
															<div class="cb_dsc_area">
																<p class="cb_dsc">
																	<input type="checkbox" name="chk_submit_m2day" id="chk_submit_m2day2" class="cb_input_chk">
																	<label for="chk_submit_m2day2" class="cb_blind">미투데이 글 등록</label>
																	<span><a href="#" target="_blank">나의 미투데이</a>에 글을 등록합니다.</span>
																</p>
																<div class="cb_btn_area3">
																	<button type="button" class="cb_help"><span>도움말</span></button>
					...
					<fieldset>
						...
						<div class="cb_usr_area">
							<div class="cb_txt_area">
								...
								<div class="cb_dsc_area">
									<p class="cb_dsc">
										<input type="checkbox" name="chk_submit_m2day" id="chk_submit_m2day4" class="cb_input_chk">
										<label for="chk_submit_m2day4" class="cb_blind">미투데이 글 등록</label>
										<span><a href="#" target="_blank">나의 미투데이</a>에 글을 등록합니다.</span>
									</p>
									<div class="cb_btn_area3">
										<button type="button" class="cb_help"><span>도움말</span></button>
