...
<div id="menu_v" class="menu_v">
	<ul>
		<li>
			...
			<ul>
				<li class="active"><a href="<c:url value="/prototype/board/${paramMap.code}" />"><span>목록</span></a></li>
				<li><a href="<c:url value="/prototype/board/${paramMap.code}/write" />"><span>등록</span></a></li>
			</ul>
		</li>
	</ul>
</div>
