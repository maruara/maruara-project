...
Raphael = (function () {
    ...
    addEvent = (function () {
        if (doc.addEventListener) {
            return function (obj, type, fn, element, scope) { //AR added scope argument
                ...
                var f = function (e) {
                    ...
                    return fn.call(scope, element, e); //AR added call here passing scope
                };
    ...
    for (var i = events[length]; i--;) {
        (function (eventName) {
            R[eventName] = Element[proto][eventName] = function (fn, scope) { //AR added scope argument
                if (R.is(fn, "function")) {
    				scope = scope || this; //AR - added scope default
                    this.events = this.events || [];
                    this.events.push({name: eventName, f: fn, unbind: addEvent(this.shape || this.node || doc, eventName, fn, this, scope)}); //AR added scope here
                }
                return this;
            };
    ...
    Element[proto].hover = function (f_in, f_out, scope) { //AR - added scope argument
    	scope = scope || this; //AR - added scope default
        return this.mouseover(f_in, scope).mouseout(f_out, scope);
    };
    Element[proto].unhover = function (f_in, f_out, scope) { //AR - added scope argument
    	scope = scope || this; //AR - added scope default
        return this.unmouseover(f_in).unmouseout(f_out);
    };
    Element[proto].drag = function (onmove, onstart, onend, scope) { //AR - added scope argument
    	scope = scope || this; //AR - added scope default
        this._drag = {};
